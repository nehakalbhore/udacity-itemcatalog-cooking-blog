...
recipe = Recipe(
    ...
    ingredients="""7 garlic cloves, finely grated 4 tsp
    ...
    ghee (clarified butter) or vegetable oil 1 small onion, thinly sliced 1/4 cup tomato paste 6 cardamom pods, crushed 2 dried chiles,1/2 tsp
    crushed red pepper flakes 
    can whole peeled tomatoes, 2 cups heavy cream 3/4 cup chopped cilantro, plus sprigs for garnish Steamed basmati rice (for serving)
""",
    ...
    Heat ghee in a large heavy pot over medium heat. Add onion, tomato paste, cardamom, 
    and chiles and cook, stirring often, until tomato paste has darkened and onion is soft, about 5 minutes. 
...
""",
    body="""Serving Size-6,In a large bowl, mix ground beef, onion powder, salt and pepper until just combined. Do not overmix, or your patties will be tough. 
    Divide into six portions and form patties, without pressing too hard. They should be uniform in thickness. Smooth out any cracks using your fingers.
    ...
    Cook until the crust that forms on the bottom of the burger releases it from the pan or grate about 2 minutes. Gently test,
    but don't flip it until it gets to this point. When burgers lift up easily, flip, add two slices of cheese to each, close lid if using a grill,
...
recipe = Recipe(
    ...
    ingredients="""1-1/4 cups margarine, softened2 cups white sugar2 eggs,
...
""",
    body="""Serving Size-48,Preheat oven to 350 degrees F (175 degrees C).
    In a large bowl, cream together margarine and sugar until smooth. Beat in eggs one at a time, 
    then stir in the vanilla. Combine flour, cocoa, baking soda, and salt; stir into the creamed mixture until just blended.
    Mix in walnuts. Drop by spoonfuls onto ungreased cookie sheets.
    Bake for 8 to 10 minutes in the preheated oven. Cool for a couple of minutes on the cookie sheet 
...
""",
    body="""Serving Size-4,In a large skillet brown chicken in oil, stirring constantly until juices run clear.
...
recipe = Recipe(
    ...
    3 teaspoons water
""",
    body="""Serving Size-10,Write fortunes on pieces of paper that are 3 1/2 inches long and 1/2 inch wide.
    ...
    Add the flour to the egg white mixture and stir until you have a smooth batter. The batter should not be runny 
    but should drop easily off a wooden spoon. Note: If you want to dye the fortune cookies, add the food coloring at this point,
    stirring it into the batter. For example, use 1/2 teaspoon green food coloring to make green fortune cookies.
    Place level tablespoons of batter onto the cookie sheet, spacing them at least 3 inches apart. 
...
""",
    body="""Serving Size-4,In a large pot of boiling salted water, cook spaghetti according to package instructions. Drain. 
    In a large bowl, combine beef with bread crumbs, parsley, Parmesan, egg, garlic, 1 teaspoon salt, and red pepper flakes. 
    Mix until just combined then form into 16 balls.
    In a large pot over medium heat, heat oil. Add meatballs and cook, turning occasionally, until browned on all sides, about 10 minutes. 
...
""",
    body="""Serving Size-8,In a clean bowl, whip the egg whites and 3 tbsp of sugar together with a hand mixer, 
    for about 3-5 minutes until the egg whites hold stiff peaks.
    ...
    Dunk each ladyfinger into the espresso mixture for 1-2 seconds and place into the bottom of a 8x8 dish, or into individual ramekins.
    Do not let the ladyfinger soak so much that it falls apart, just a quick dunk to let it absorb a little bit of espresso.
